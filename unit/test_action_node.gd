...
func test_from_dict():
	var arg1_dict = {"Name": "first_argument", "Type": "Variable", "Value": "my_variable_name"}
	var arg2_dict = {"Name": "second_argument", "Type": "Boolean", "Value": true}
...
func test_arguments_to_dict():
	var arg1_dict = {"Name": "the_first_argument", "Type": "Integer", "Value": -24}
	...
	assert_array(args).is_equal([arg1_dict, {"Name": "", "Type": "Boolean", "Value": false}])
